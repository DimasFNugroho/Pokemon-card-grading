...
def white_background_segmentation(img, debug=False, show_ratio=1):
	...
	print("6. Get edges")
	show_image(debug, edges, show_ratio)
	...
	show_image(debug, convex_hull, show_ratio)
	...
	show_image(debug, masked, show_ratio)
